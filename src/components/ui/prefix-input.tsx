  ...
  ({ className, prefix, ...props }, ref) => {
    return (
      <div className="flex h-10 w-full rounded-md border border-input overflow-hidden bg-background prefix-input-wrapper">
        ...
        <input
          className={cn(
            "flex h-full w-full px-3 py-2 text-base file:border-0 file:bg-transparent file:text-sm file:font-medium focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 md:text-sm rounded-none prefix-input-field",
            className
          )}
          ref={ref}
          {...props}
