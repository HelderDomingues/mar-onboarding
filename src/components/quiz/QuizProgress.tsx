  ...
  return (
    <div className="w-full max-w-2xl mx-auto mb-8 space-y-4">
      ...
      <div className="flex justify-between mb-2 text-sm">
        ...
        <Badge variant="outline" className="border-[hsl(var(--quiz-border))]">
      ...
      <div className="space-y-1">
        ...
        <div className="quiz-progress-bar overflow-hidden">
          <div
            className="quiz-progress-value transition-all duration-300 ease-in-out"
          ...
          <div key={step} className="flex items-center">
            <div
              className={`flex items-center justify-center w-8 h-8 rounded-full text-sm font-medium transition-all ${
                step < currentModule
                  ? "bg-[hsl(var(--quiz-accent))] text-white"
                  : step === currentModule
                  ? "bg-[hsl(var(--quiz-accent-hover))] text-white ring-4 ring-[hsl(var(--quiz-accent))]/20"
                  : "bg-[hsl(var(--quiz-progress-bg))] text-muted-foreground"
              }`}
            >
            ...
            {step < totalModules && (
              <div className="flex-1 h-[2px] mx-2 bg-[hsl(var(--quiz-progress-bg))]">
                <div 
                  className="h-full bg-[hsl(var(--quiz-accent))] transition-all duration-500"
                  style={{ width: step < currentModule ? "100%" : "0%" }}
                />
              </div>
            )}
          </div>
