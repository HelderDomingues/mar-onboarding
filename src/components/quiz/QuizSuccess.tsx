      ...
      <Card className="quiz-card overflow-hidden">
        ...
        <CardContent className="text-center px-6">
          ...
          <div className="bg-slate-50 rounded-lg p-6 border border-[hsl(var(--quiz-border))]">
            <h3 className="font-semibold text-lg mb-3 text-slate-800">Próximos passos</h3>
            ...
            <h4 className="font-medium mt-4 mb-2 text-slate-800">Fale com um consultor</h4>
        ...
        <CardFooter className="flex justify-center gap-4 flex-col md:flex-row p-6">
          ...
          <a href="https://lovable.dev/projects/a882ff86-3929-4dd9-a7ce-87e37dd08713" target="_blank" rel="noopener noreferrer">
            <Button variant="outline" className="w-full md:w-auto text-slate-900">
