          ...
          <CardContent className="pt-6 pb-4">
            ...
            <div className="mb-6">
              <AspectRatio ratio={16 / 9} className="bg-slate-100 rounded-lg overflow-hidden mb-4">
                <iframe src="https://youtu.be/eE9GDF4lq2Q" title="Vídeo de Introdução ao MAR" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" className="w-full h-full object-cover" />
              </AspectRatio>
