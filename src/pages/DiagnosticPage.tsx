  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-blue-50 to-white">
      ...
      <main className="flex-1 container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-6">
          <h1 className="text-3xl font-bold text-gray-900">Diagnóstico do Sistema MAR</h1>
          <p className="mt-2 text-gray-600">
            Ferramentas de diagnóstico unificadas para verificar conexão, estrutura de dados e resolução de problemas do sistema.
          </p>
        </div>
