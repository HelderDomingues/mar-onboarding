...
const Dashboard = () => {
  ...
  if (isLoading) {
    return <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-blue-50 to-white">
  ...
  return <div className="min-h-screen flex flex-col bg-gradient-to-b from-blue-50 to-white">
      ...
      <div className="flex-1 container mx-auto px-4 sm:px-6 lg:px-8 py-8 bg-slate-200">
        {isAdmin ? <AdminDashboard isAdmin={isAdmin} submission={submission} /> : <UserDashboard submission={submission} />}
      </div>
