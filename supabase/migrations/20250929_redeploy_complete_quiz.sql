-- 2025-09-29: Redeploy complete_quiz function (DROP + CREATE + GRANT)
-- This migration drops any existing complete_quiz(uuid) and recreates it with the safe implementation

BEGIN;

-- Drop exact-signature function if present
DROP FUNCTION IF EXISTS public.complete_quiz(uuid);
